import { Percent, Token, TokenAmount, CAVAX } from '../../entities'
...
export interface CommonAddLiquidityOptions {
   ...
   */
  useNative?: Token //NativeCurrency
...
export abstract class NonfungiblePositionManager {
  ...
  private static encodeCollect(options: CollectOptions): string[] {
    ...
    const involvesETH =
      options.expectedCurrencyOwed0.currency === CAVAX[chainId] ||
      options.expectedCurrencyOwed1.currency === CAVAX[chainId]
