import { Percent, Price, TokenAmount, Fraction } from '../../entities'
import JSBI from 'jsbi'
import invariant from 'tiny-invariant'
import { ZERO, BigintIsh, SOLIDITY_TYPE_MAXIMA, SolidityType } from '../../constants'
...
export class Position {
  ...
  private ratiosAfterSlippage(slippageTolerance: Percent): { sqrtRatioX96Lower: JSBI; sqrtRatioX96Upper: JSBI } {
    const token0PriceFraction = new Fraction(
      this.pool.token0Price?.numerator.toString(),
  ...
  public static fromAmount0({
    ...
    return Position.fromAmounts({
      ...
      tickUpper,
      amount0,
      amount1: SOLIDITY_TYPE_MAXIMA[SolidityType.uint256],
      useFullPrecision
    })
  }
  ...
  public static fromAmount1({
    ...
    return Position.fromAmounts({
      ...
      tickLower,
      tickUpper,
      amount0: SOLIDITY_TYPE_MAXIMA[SolidityType.uint256],
      amount1,
